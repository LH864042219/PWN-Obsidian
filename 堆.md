...
这里用CTFshow里的[pwn141](https://ctf.show/challenges#pwn141-4160)来测试
...
简单来说，通过修改一个chunk的size域，然后再free该chunk，触发prev size复用
![[Pasted image 20250316212537.png]]
这里用CTFshow的[pwn142](https://ctf.show/challenges#pwn142-4161)
